    ...
    >
      ...
      <div id="about" data-section="about">
        <SplitAbout
          ...
          buttons={[
            {
              text: "Schedule Consultation",              href: "about"},
          ]}
          buttonAnimation="slide-up"
          bulletPoints={[
            {
              title: "Confidentiality First",              description:
                "We maintain strict confidentiality protocols throughout the entire transaction process, protecting your business reputation and employee morale.",              icon: Shield,
            },
            {
              title: "Tax & Legal Expertise",              description:
                "Our team includes experienced tax consultants and legal advisors who optimize your exit structure for maximum post-tax returns.",              icon: CheckCircle,
            },
            {
              title: "Proven Track Record",              description:
                "Successfully facilitated over 500+ business sales ranging from ₹5 crore to ₹500+ crore valuations across diverse sectors.",              icon: Award,
            },
            {
      ...
      <div id="features" data-section="features">
        <FeatureHoverPattern
          ...
          features={[
            {
              icon: DollarSign,
              title: "Business Valuation",              description:
            ...
            {
              icon: Users,
              title: "Buyer Identification",              description:
            ...
            {
              icon: FileText,
              title: "Documentation & Due Diligence",              description:
            ...
            {
              icon: Handshake,
              title: "Negotiation & Structuring",              description:
            ...
            {
              icon: TrendingUp,
              title: "Transition Planning",              description:
      ...
      <div id="why-us" data-section="why-us">
        <MetricCardTen
          ...
          metrics={[
            {
              id: "1",              title: "500+ Successful Exits",              subtitle:
                "Facilitated business sales across India with average 6-12 month timelines",              category: "Experience",              value: "₹2000+ Cr"},
            {
              id: "2",              title: "Expert Team of 25+",              subtitle:
                "Seasoned advisors with 15+ years average experience in M&A and exit planning",              category: "Expertise",              value: "100% Qualified"},
            {
              id: "3",              title: "98% Client Satisfaction",              subtitle:
                "Consistently rated highly for professionalism, confidentiality, and results delivery",              category: "Quality",              value: "Industry Leading"},
            {
              id: "4",              title: "Strategic Network",              subtitle:
                "Connected with 200+ pre-qualified buyers including PE firms, strategic investors, and entrepreneurs",              category: "Network",              value: "Exclusive Access"},
            {
              id: "5",              title: "Zero Conflicts",              subtitle:
                "Independent advisory with no competing interests - your success is our only agenda",              category: "Integrity",              value: "Fully Aligned"},
            {
              id: "6",              title: "Confidentiality Guaranteed",              subtitle:
                "Multi-layer security protocols and NDA compliance with zero data breaches in 20+ years",              category: "Trust",              value: "Bank-Grade Security"},
          ]}
          animationType="slide-up"
          textboxLayout="default"
          useInvertedBackground={true}
      ...
      <div id="testimonials" data-section="testimonials">
        <TestimonialCardThirteen
          ...
          testimonials={[
            {
              id: "1",              name: "Rajesh Kumar",              handle: "Founder, TechSoft Solutions",              testimonial:
                "IndiaBusinessSale made my exit seamless and confidential. They maximized my valuation by 35% through smart structuring. The entire team was professional, transparent, and truly understood my concerns about employee welfare during the transition.",              rating: 5,
              imageSrc: "http://img.b2bpic.net/free-photo/smiling-middle-aged-business-leader-window_1262-5674.jpg",              imageAlt: "professional tech entrepreneur portrait"},
            {
              id: "2",              name: "Priya Sharma",              handle: "CEO, Fashion & Home Co.",              testimonial:
                "After 15 years building my brand, I needed the right partner for exit. Their buyer network was impressive, and they secured an offer 40% above my initial expectations. Tax optimization alone saved me over ₹3 crores. Highly recommended!",              rating: 5,
              imageSrc: "http://img.b2bpic.net/free-photo/full-body-woman-standing_1149-1823.jpg",              imageAlt: "professional female CEO business portrait"},
            {
              id: "3",              name: "Amit Patel",              handle: "Managing Partner, Manufacturing House",              testimonial:
                "The confidentiality they maintained was exceptional - not even our employees knew we were in exit discussions. Their legal and tax teams ensured zero compliance issues. The entire process took just 9 months from valuation to closing.",              rating: 5,
              imageSrc: "http://img.b2bpic.net/free-photo/businessman-looking-camera-with-arms-crossed_23-2148308598.jpg",              imageAlt: "manufacturing industry professional portrait"},
            {
              id: "4",              name: "Sneha Desai",              handle: "Founder, Digital Marketing Agency",              testimonial:
                "I was uncertain about exit timings and terms. IndiaBusinessSale provided realistic counseling and didn't pressure me. When I was ready, they moved fast - finding the perfect strategic buyer who valued our culture and team.",              rating: 5,
              imageSrc: "http://img.b2bpic.net/free-photo/woman-posing-with-cup-coffee_23-2149330971.jpg",              imageAlt: "digital marketing founder woman portrait"},
            {
              id: "5",              name: "Vikram Singh",              handle: "Director, Healthcare Services Ltd",              testimonial:
                "Their regulatory expertise in healthcare compliance was crucial. They navigated MCA and industry-specific FDI rules perfectly. I closed successfully with a foreign strategic investor without any compliance delays.",              rating: 5,
              imageSrc: "http://img.b2bpic.net/free-photo/portrait-man-doctor-with-stethoscope-lights_181624-15323.jpg",              imageAlt: "healthcare executive professional portrait"},
            {
              id: "6",              name: "Meera Nair",              handle: "Co-founder, E-commerce Platform",              testimonial:
                "From first call to final closing in 8 months. They handled everything - valuation, buyer vetting, due diligence coordination, and post-sale transition planning. Truly a one-stop solution for business exit.",              rating: 5,
              imageSrc: "http://img.b2bpic.net/free-photo/lifestyle-people-office_23-2149173784.jpg",              imageAlt: "e-commerce founder woman entrepreneur portrait"},
          ]}
          animationType="slide-up"
        />
      </div>
