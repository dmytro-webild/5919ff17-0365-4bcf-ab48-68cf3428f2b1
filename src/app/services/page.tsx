    ...
    >
      ...
      <div id="services" data-section="services">
        <ProductCardFour
          ...
          products={[
            {
              id: "valuation",              name: "Business Valuation & Analysis",              price: "Starting ₹50,000",              variant: "Strategic Planning",              imageSrc: "http://img.b2bpic.net/free-photo/whiteboard-success-research-adult-human-office_1418-529.jpg?_wi=2",              imageAlt: "Business valuation financial analysis documents"},
            {
            ...
            {
              id: "buyer-sourcing",              name: "Buyer Identification & Sourcing",              price: "Commission-based",              variant: "Success-Driven",              imageSrc: "http://img.b2bpic.net/free-photo/african-man-guy-black-suit-students-with-talet-girl-white-blouse_1157-41615.jpg?_wi=2",              imageAlt: "business buyer network meeting handshake"},
            {
              id: "tax-optimization",              name: "Tax & Structure Optimization",              price: "Starting ₹75,000",              variant: "Post-Tax Maximization",              imageSrc: "http://img.b2bpic.net/free-vector/hand-drawn-credit-assessment-concept_23-2149167956.jpg?_wi=2",              imageAlt: "tax planning financial strategy consultation"},
            {
              id: "legal-compliance",              name: "Legal & Regulatory Compliance",              price: "Starting ₹1,00,000",              variant: "Full Documentation",              imageSrc: "http://img.b2bpic.net/free-photo/still-life-world-intellectual-property-day_23-2151325873.jpg?_wi=2",              imageAlt: "legal compliance documents contract review"},
            {
              id: "due-diligence",              name: "Due Diligence Management",              price: "Starting ₹2,00,000",              variant: "Professional Support",              imageSrc: "http://img.b2bpic.net/free-photo/analyzing-lifestyle-female-marketing-tech-high_1421-249.jpg?_wi=2",              imageAlt: "due diligence document review process"},
          ]}
