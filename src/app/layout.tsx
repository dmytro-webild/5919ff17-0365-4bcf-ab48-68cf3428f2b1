...
export const metadata: Metadata = {
  title: "IndiaBusinessSale | Sell Your Business Confidentially & Profitably",
  description: "Expert business exit advisory for Indian entrepreneurs. Confidential valuations, buyer sourcing, tax optimization & legal support. Maximize your business sale value. Get free valuation today.",
  keywords: "business sale India, business exit, M&A advisory, business valuation, sell business, exit planning, business buyer, acquisition India",
  metadataBase: new URL("https://www.indiabusinesssale.com"),
  alternates: {
    canonical: "https://www.indiabusinesssale.com",
  },
  openGraph: {
    title: "IndiaBusinessSale | Sell Your Business with Confidence",
    description: "India's trusted business exit advisor. Confidential exits. Maximum valuations. Expert legal & tax support.",
    url: "https://www.indiabusinesssale.com",
    siteName: "IndiaBusinessSale",
    type: "website",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/business-partners-meeting-breakfast_74855-1160.jpg",
        alt: "Professional business consulting office",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Sell Your Business Confidentially & Profitably | IndiaBusinessSale",
    description: "Expert business exit advisory for Indian entrepreneurs. Confidential exits. Maximum valuations. Free valuation today.",
    images: ["http://img.b2bpic.net/free-photo/business-partners-meeting-breakfast_74855-1160.jpg"],
  },
  robots: {
    index: true,
    follow: true,
